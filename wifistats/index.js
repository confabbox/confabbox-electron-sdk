...
/**
 * Setup getWiFiStats to be available in ConfabboxElectron object.
 *
...
function setupWiFiStats(iframe) {
    iframe.addEventListener('load', () => {
        ...
        if(typeof ctx.ConfabboxJS === "undefined")
            ctx.ConfabboxJS = {};

        if(typeof ctx.ConfabboxJS.app === "undefined")
            ctx.ConfabboxJS.app = {};

        ctx.ConfabboxJS.app.getWiFiStats = getWiFiStats;
    });
}
