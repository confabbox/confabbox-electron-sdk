...
class ScreenShareRenderHook {
    /**
     * Creates a ScreenShareRenderHook hooked to confabbox iframe events.
     *
     ...
     */
    _onIframeApiLoad() {
        this._iframe.contentWindow.ConfabboxElectron = {
            /**
    ...
    _onScreenSharingEvent(event, { data }) {
        switch (data.name) {
            ...
            // Send appropriate command to confabbox api.
    ...
    /**
     * React to screen sharing events coming from the confabbox api. There should be
