...
class RemoteControl {
     ...
     *
     * @param {HTMLElement} iframe the Confabbox iframe.
     */
    constructor(iframe) {
        this._iframe = iframe;
    ...
    _setDisplayMetrics(sourceId) {
        this._display = ipcRenderer.sendSync('confab-remotecontrol-get-display', sourceId);
    }
    ...
    _start(id, sourceId) {
        ...
        ipcRenderer.on('confab-remotecontrol-displays-changed', this._displayMetricsChangeListener);
        this._setDisplayMetrics(sourceId);
    ...
    _stop() {
        ...
        if (this._displayMetricsChangeListener) {
            ipcRenderer.removeListener('confab-remotecontrol-displays-changed', this._displayMetricsChangeListener);
