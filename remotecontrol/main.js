...
class RemoteControlMain {
    constructor(confabboxWindow) {
        this._confabboxWindow = confabboxWindow;

        ipcMain.on('confab-remotecontrol-get-display', (event, sourceId) => {
        ...
        app.whenReady().then(() => {
            ...
            screen.on('display-metrics-changed', () => {
                this._confabboxWindow.webContents.send('confab-remotecontrol-displays-changed');
            });
        });
    }
